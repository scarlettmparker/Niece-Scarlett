...
type Documents = {
    ...
    "query listAnnotations($textId: ID!, $includeHidden: Boolean, $pagination: PaginationInput) {\n  hadesQueries {\n    annotations(\n      textId: $textId\n      includeHidden: $includeHidden\n      pagination: $pagination\n    ) {\n      items {\n        id\n        body\n        upvotes\n        downvotes\n        netScore\n        replyCount\n        author {\n          type\n          id\n        }\n        authorProfile {\n          discordUsername\n          globalName\n        }\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}": typeof types.ListAnnotationsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query listAnnotations($textId: ID!, $includeHidden: Boolean, $pagination: PaginationInput) {\n  hadesQueries {\n    annotations(\n      textId: $textId\n      includeHidden: $includeHidden\n      pagination: $pagination\n    ) {\n      items {\n        id\n        body\n        upvotes\n        downvotes\n        netScore\n        replyCount\n        author {\n          type\n          id\n        }\n        authorProfile {\n          discordUsername\n          globalName\n        }\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"): (typeof documents)["query listAnnotations($textId: ID!, $includeHidden: Boolean, $pagination: PaginationInput) {\n  hadesQueries {\n    annotations(\n      textId: $textId\n      includeHidden: $includeHidden\n      pagination: $pagination\n    ) {\n      items {\n        id\n        body\n        upvotes\n        downvotes\n        netScore\n        replyCount\n        author {\n          type\n          id\n        }\n        authorProfile {\n          discordUsername\n          globalName\n        }\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */

...
import { CefrLevel, ReaderTextStatus, } from "~/generated/graphql.js";
...
describe("text loader", () => {
    ...
    it("returns the text when found", async () => {
        ...
        const data = await resolvePageData("text", "texts/:id", { id: "abc" });
    ...
    it("returns an empty text when not found", async () => {
        ...
        const data = await resolvePageData("text", "texts/:id", { id: "missing" });
        expect(data.id).toBe("");
    });
});

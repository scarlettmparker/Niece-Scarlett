...
describe("command-intents loader", () => {
    ...
    it("returns the intents from the property set", async () => {
        ...
        const intents = await resolvePageData("intents", "command-intents", { variant: "present" });
    ...
    it("returns an empty list when the property set is missing", async () => {
        ...
        const intents = await resolvePageData("intents", "command-intents", { variant: "missing" });

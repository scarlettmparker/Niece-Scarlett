 ...
 */
export function cefrScale(level) {
 ...
 */
export function weightedLevelLabel(probabilities) {
 ...
 * @param probabilities the predicted level probabilities
 */
function modeLevel(probabilities) {
    let best = null;
 ...
 */
function windowedEstimate(probabilities, mode) {

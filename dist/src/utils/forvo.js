...
function curlText(url) {
    return new Promise((resolve) => {
        execFile("curl", [...CURL_FLAGS, url], { encoding: "utf-8", maxBuffer: 10 * 1024 * 1024, timeout: 15_000 }, (error, stdout) => {
 ...
 */
export function wordPageUrl(word) {
 ...
 */
export function greekAudioUrl(html) {
    ...
    const path = args.length >= 3 ? Buffer.from(args[2], "base64").toString("utf-8") : "";
 ...
 * @param word the word to look up
 */
export async function fetchWordPage(word) {
